...
describe('getDaysInMonth', () => {
  ...
  it('유효하지 않은 월에 대해 적절히 처리한다', () => {
    expect(getDaysInMonth(2024, 13)).toBeTruthy();
  });
});
...
describe('getWeekDates', () => {
  ...
  it('주중의 날짜(수요일)에 대해 올바른 주의 날짜들을 반환한다', () => {
    expect(getWeekDates(new Date('2024-07-04'))).toEqual([
      new Date('2024-06-30'),
      new Date('2024-07-01'),
      new Date('2024-07-02'),
      new Date('2024-07-03'),
  ...
  it('주의 시작(월요일)에 대해 올바른 주의 날짜들을 반환한다', () => {
    expect(getWeekDates(new Date('2024-07-01'))).toEqual([
      new Date('2024-06-30'),
      new Date('2024-07-01'),
      new Date('2024-07-02'),
      new Date('2024-07-03'),
  ...
  it('주의 끝(일요일)에 대해 올바른 주의 날짜들을 반환한다', () => {
    expect(getWeekDates(new Date('2024-07-07'))).toEqual([
      new Date('2024-07-07'),
      new Date('2024-07-08'),
      new Date('2024-07-09'),
      new Date('2024-07-10'),
  ...
  it('월의 마지막 날짜를 포함한 주를 올바르게 처리한다', () => {
    expect(getWeekDates(new Date('2024-07-31'))).toEqual([
      new Date('2024-07-28'),
      new Date('2024-07-29'),
      new Date('2024-07-30'),
      new Date('2024-07-31'),
...
describe('formatDate', () => {
  ...
  it('day 파라미터가 제공되면 해당 일자로 포맷팅한다', () => {
    expect(formatDate(new Date('2024-07-10'), 15)).toBe('2024-07-15');
  });
